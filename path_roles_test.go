...
const (
	roleName     = "testfortigate"
	testTTL      = int64(120)
	testMaxTTL   = int64(3600)
	adminProfile = "testprofile"
)
...
func TestUserRole(t *testing.T) {
	...
	t.Run("Read User Role", func(t *testing.T) {
		...
		require.Equal(t, resp.Data["admin_profile"], adminProfile)
	})
...
func testTokenRoleCreate(t *testing.T, b *fortigateBackend, s logical.Storage, name string, d map[string]interface{}) (*logical.Response, error) {
	t.Helper()
...
func testTokenRoleUpdate(t *testing.T, b *fortigateBackend, s logical.Storage, d map[string]interface{}) (*logical.Response, error) {
	t.Helper()
	resp, err := b.HandleRequest(context.Background(), &logical.Request{
...
func testTokenRoleRead(t *testing.T, b *fortigateBackend, s logical.Storage) (*logical.Response, error) {
	t.Helper()
...
func testTokenRoleList(t *testing.T, b *fortigateBackend, s logical.Storage) (*logical.Response, error) {
	t.Helper()
	return b.HandleRequest(context.Background(), &logical.Request{
...
func testTokenRoleDelete(t *testing.T, b *fortigateBackend, s logical.Storage) (*logical.Response, error) {
	t.Helper()
	return b.HandleRequest(context.Background(), &logical.Request{
